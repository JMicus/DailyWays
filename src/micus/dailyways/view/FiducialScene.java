...
public class FiducialScene extends AbstractScene implements IMTInputEventListener {
	...
	public FiducialScene(AbstractMTApplication mtApplication, String name, InputController inputController) {
	...
	public boolean processInputEvent(MTInputEvent inEvt) {
		...
		if (inEvt instanceof MTFiducialInputEvt) {
			...
			case MTFiducialInputEvt.INPUT_STARTED:
				inputController.fiducialAdded(fID, position.getX(), position.getY());
			...
			case MTFiducialInputEvt.INPUT_UPDATED:
				inputController.fiducialUpdated(fID, position.getX(), position.getY());
			...
			case MTFiducialInputEvt.INPUT_ENDED:
				inputController.fiducialEnded(fID, position.getX(), position.getY());
				comp = fiducialIDToComp.get(fID);
				if (comp != null){
					comp.destroy();
