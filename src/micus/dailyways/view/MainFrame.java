...
/**
* Frame to display a map. It's basically the demo by Jan Peter Stotz.
*
*/
public class MainFrame extends JFrame implements JMapViewerEventListener  {
 ...
 public MainFrame() {
     ...
     // listener for mouse input (for testing)
     ...
     //showZoomControls.setSelected(false);
     ...
     scrollWrapEnabled.setSelected(true);
...
public void test() {
	System.out.println("MainFrame test");
}
