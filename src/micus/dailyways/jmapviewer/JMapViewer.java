...
package micus.dailyways.jmapviewer;
...
public class JMapViewer extends JPanel implements TileLoaderListener {
    ...
    public static final int MAX_ZOOM = Settings.MAX_ZOOM;
    public static final int MIN_ZOOM = Settings.MIN_ZOOM;
